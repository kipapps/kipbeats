        ...
        <div class="img-wrapper">
            <?php 
                if ( has_post_thumbnail() ) {
                    the_post_thumbnail(@$imageSize ?: "full", array('class' => 'img-fluid'));
                } elseif (get_post_meta(get_the_ID(), 'video', true)) {
                    get_youtube_cover_img(array('url'=>get_post_meta(get_the_ID(), 'video', true)));
                } ?>
        </div>
